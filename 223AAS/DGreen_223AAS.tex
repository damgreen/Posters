...
\title{Heavy Cosmic Rays in the Fermi-LAT}
...
\end{itemize}
    ...
    \begin{minipage}[t]{0.45\textwidth}
      ...
      \centering\includegraphics[width=1.08 \textwidth]{BC_ratio_new.pdf}
...
\item We can improve LAT's ability to measure heavy cosmic rays
\end{itemize}

  }


  \headerbox{Selecting Heavy Cosmic Rays}{name=pathlength,column=0,span=3,
...
\end{itemize}
 ...
 \includegraphics[width =  1.03 \textwidth]{species.pdf}  
      \captionof{figure}{Path length corrected energy deposition in the top of CAL.  Red areas indicate selection used for identification of heavy cosmic ray charge.}
...
\item Possible to use ACD (and CAL) to select heavy cosmic ray elements
\end{itemize}
...
%    \end{minipage}
  ...
  \headerbox{Future Work}{name=box5,column=3,span=3,
...
\centering\includegraphics[width=1.08 \textwidth]{CalEnergyRaw-CalFullLen_mom12.pdf}
...
\begin{itemize}
\item We are able to measure heavy cosmic ray's charge and energy with the LAT
\item ACD charge resolution is drastically improved via uniform signal and path length correction using heavy cosmic rays as a calibration source
